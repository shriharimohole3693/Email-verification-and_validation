...
# Custom CSS for styling and animations with gradient background
st.markdown("""
    <style>
    body {
        background-image: linear-gradient(to right top, #00c6ff, #00b9ff, #00abff, #009cff, #008bff, #007ef3, #0372e7, #0765da, #115bbf, #1750a5, #1c468b, #1e3c72);
...
def show_home():
    ...
    with col1:
        st.markdown("<div class='image zoom-out'>", unsafe_allow_html=True)  # Add class here
...
# Display footer
def show_footer():
    st.markdown('<div class="footer"><div class="footer-content">© 2024 Your Company. All rights reserved.</div></div>', unsafe_allow_html=True)

# Main function to display sections
def main():
    show_home()
    show_footer()
